...
export default function CookieBanner() {
  console.log('CookieBanner (in pages/components) MONTATO - rendering del componente iniziato');
  ...
  useEffect(() => {
    ...
    console.log('CookieBanner (in pages/components) - Initializing...');
    
    // Mostra il banner immediatamente se il consenso non è stato ancora dato
    try {
      const consentValue = getConsent();
      console.log('CookieBanner (in pages/components) - Consent value:', consentValue);
      
      if (consentValue === null) {
        console.log('CookieBanner (in pages/components) - Showing banner IMMEDIATELY');
        setShow(true);
      } else {
        console.log('CookieBanner (in pages/components) - Consent already provided, not showing banner');
      }
    } catch (error) {
      console.error('CookieBanner (in pages/components) - Error checking consent:', error);
