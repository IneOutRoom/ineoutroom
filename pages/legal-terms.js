...
export default function LegalTermsPage() {
  ...
  const pageSchemaData = generateWebPageSchema({
    title: "Termini e Condizioni di Utilizzo - In&Out Room",
    description: "Termini e condizioni per l'utilizzo della piattaforma In&Out Room per la ricerca di stanze e alloggi in Europa.",
    url: "https://ineoutroom.eu/legal-terms",
  ...
  return (
    <>
      <SEO 
        title="Termini e Condizioni di Utilizzo - In&Out Room"
        description="Termini e condizioni per l'utilizzo della piattaforma In&Out Room per la ricerca di stanze e alloggi in Europa. Politiche di utilizzo, registrazione, pubblicazione annunci e pagamenti."
        keywords="termini, condizioni, utilizzo, legali, regolamento, In&Out Room, contratto, privacy, GDPR, diritti utente"
        ...
        <main className="flex-grow container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-6 md:p-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p>
                Le presenti Condizioni Generali di Contratto (di seguito, i "Termini") disciplinano l'accesso e l'uso del sito web In&Out Room (https://ineoutroom.eu, di seguito il "Sito") e dei servizi ad esso collegati (di seguito, i "Servizi"), offerti da:
              </p>
              ...
              <h2 id="oggetto-finalita">2. Oggetto e Finalità</h2>
              <p>
                In&Out Room fornisce una piattaforma online di vetrina per annunci di locazione, permettendo a privati e agenzie di pubblicare e a chi cerca di consultare offerte. In&Out Room non interviene nelle trattative, non verifica la veridicità degli Annunci e non assume responsabilità contrattuale tra le parti.
              </p>
              
              <h2 id="registrazione-account">3. Registrazione e Account</h2>
              <p>
              ...
              <h2 id="pubblicazione-annunci">4. Pubblicazione e Gestione degli Annunci</h2>
              <p>
                ...
                <strong>Moderazione:</strong> In&Out Room può rimuovere gli Annunci in caso di violazione di legge, diritti di terzi o di questi Termini.<br /><br />
                <strong>Responsabilità:</strong> In&Out Room non verifica preventivamente le informazioni; l'Utente è unico responsabile di eventuali controversie o danni.
              </p>
              
              <h2 id="piani-pagamenti">5. Piani di Pubblicazione e Pagamenti</h2>
              <p>
                ...
                <strong>Modalità di Pagamento:</strong> PayPal e Stripe, gestiti da terzi; In&Out Room non detiene dati di pagamento.<br /><br />
              ...
              <h2 id="proprieta-intellettuale">6. Proprietà Intellettuale</h2>
              <p>
                <strong>Diritti In&Out Room:</strong> il sito, la grafica, il codice e i marchi sono di proprietà di In&Out Room o dei rispettivi licenzianti.<br /><br />
                <strong>Diritti Utente:</strong> l'Utente conserva la paternità sui Contenuti Utente e concede a In&Out Room licenza non esclusiva e gratuita per pubblicare e distribuire tali contenuti nell'ambito dei Servizi.<br /><br />
                <strong>Divieti:</strong> è vietata ogni riproduzione o sfruttamento commerciale non autorizzato.
              </p>
              
              <h2 id="trattamento-dati">7. Trattamento dei Dati Personali</h2>
              <p>
              ...
              <h2 id="limitazione-responsabilita">9. Esonero e Limitazione di Responsabilità</h2>
              <p>
                ...
                <strong>Nessuna Responsabilità:</strong> In&Out Room non risponde per danni diretti, indiretti, consequenziali o punitivi derivanti dall'uso del Sito o da transazioni tra Utenti.<br /><br />
                <strong>Forza Maggiore:</strong> In&Out Room non è responsabile per eventi imprevedibili o esterni che impediscano la fornitura del Servizio.
              </p>
              
              <h2 id="modifiche-termini">10. Modifiche ai Termini</h2>
              <p>
                In&Out Room può modificare i presenti Termini in qualsiasi momento. Le variazioni saranno efficaci alla pubblicazione sul Sito. L'uso continuato dopo la pubblicazione costituisce accettazione delle modifiche.
              </p>
              
              <h2 id="durata-risoluzione">11. Durata e Risoluzione</h2>
              <p>
                <strong>Durata:</strong> i Termini rimangono in vigore fino a eventuale modifica o cessazione del Sito.<br /><br />
                <strong>Sospensione Account:</strong> In&Out Room può sospendere o chiudere l'Account in caso di violazione dei Termini, fatto salvo il risarcimento dei danni subiti.
              </p>
              
              <h2 id="legge-foro">12. Legge Applicabile e Foro Competente</h2>
              <p>
              ...
              <p>
                Di seguito sono riportate le informazioni legali relative alla società che gestisce la piattaforma In&Out Room.
              </p>
              ...
              <p className="mt-8 text-sm text-muted-foreground italic">
                Grazie per aver scelto In&Out Room. Ci impegniamo a offrire un servizio trasparente e conforme alla normativa.
              </p>
            </div>
          </div>
        </main>
